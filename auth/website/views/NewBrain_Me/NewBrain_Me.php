        ...
        <div class="col-6">
            <div id="shadow-box" class="profile" style="min-height: 330px;">
                ...
                <div class="overlay" style="min-height: 330px;">
					...
					<b><img src="/auth/assets/img/credits.png" width="15px"> <?=$brainUserData->userCredits?></b> <br>
					<b><img src="/auth/assets/img/duckets.png" width="15px"> <?=User::userData('vip_points')?></b> <br>
					<b><img src="/auth/assets/img/diamonds.png" width="14px" title="SS Punten"> <?=User::userData('activity_points')?></b> <br>
